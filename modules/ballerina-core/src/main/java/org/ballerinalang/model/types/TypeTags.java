...
public class TypeTags {
    ...
    public static final int JSON_TAG = 8;
    public static final int MESSAGE_TAG = 9;
    public static final int DATATABLE_TAG = 10;
    public static final int VOID_TAG = 11;
    public static final int CONNECTOR_TAG = 12;
    ...
    public static final int BLOB_TAG = 17;
